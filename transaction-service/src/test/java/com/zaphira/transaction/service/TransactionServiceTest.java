...
class TransactionServiceTest {
    ...
    void setup() {
        ...
        when(stateHistoryRepository.save(any(TransactionStateHistory.class))).thenAnswer(invocation -> {
            TransactionStateHistory arg = invocation.getArgument(0);
            return arg;
        });
    }
    ...
    void authorizeTransaction_shouldProcessAfterApproval() {
        ...
        AuthorizationValidationRequest request = AuthorizationValidationRequest.builder()
            .method(AuthorizationMethod.OTP)
