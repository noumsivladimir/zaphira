...
public class TransactionSearchService {
    ...
    public Page<Transaction> search(TransactionSearchRequest searchRequest, Pageable pageable) {
        ...
        Page<Transaction> results = transactionRepository.searchTransactions(
                ...
                searchRequest.getAmountMin(),
                searchRequest.getAmountMax(),
                searchRequest.getCreatedFrom(),
                searchRequest.getCreatedTo(),
                searchRequest.getReference(),
                searchRequest.getCurrency(),
                searchRequest.getRoute(),
                searchRequest.getScheduled(),
                pageable
        );

        log.debug("Found {} transactions matching criteria", results.getTotalElements());
        return results;
    }
