...
public class TransactionRefundService {
    ...
    private void updateWalletBalancesForRefund(
        ...
        if (originalTransaction.getReceiverWallet() != null) {
            ...
            walletService.updateWalletBalance(originalTransaction.getReceiverWallet().getId(), newBalance);
        }
        ...
        if (originalTransaction.getSenderWallet() != null) {
            ...
            walletService.updateWalletBalance(originalTransaction.getSenderWallet().getId(), newBalance);
        }
    }
