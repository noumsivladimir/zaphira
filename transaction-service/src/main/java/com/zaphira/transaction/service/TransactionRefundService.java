...
//
//import com.zaphira.transaction.dto.requests.TransactionRefundRequest;
//import com.zaphira.transaction.dto.requests.TransactionRefundRequest.RefundType;
//import com.zaphira.transaction.dto.response.TransactionRefundResponse;
...
//                request.getRefundAmount(),
//                originalTransaction.getCurrency().getName(),
//                request.getReason(),
//                TransactionStatus.COMPLETED.toString(),
//                isPartialRefund ? TransactionStatus.COMPLETED.toString() : TransactionStatus.REVERSED.toString(),
//                "SUCCESS",
//                null,
//                ipAddress,
//                userAgent,
...
//                .currency(originalTransaction.getCurrency().getName())
//                .refundType(request.getRefundType().toString())
//                .originalTransactionStatus(isPartialRefund ? TransactionStatus.COMPLETED : TransactionStatus.REVERSED)
