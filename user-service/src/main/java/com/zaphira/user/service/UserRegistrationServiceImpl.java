...
import com.zaphira.user.client.WalletServiceClient;
import com.zaphira.user.dto.event.UserEventPublisher;
...
import com.zaphira.user.dto.response.WalletResponse;
...
import com.zaphira.user.repository.AdminUserRepository;
import com.zaphira.user.repository.MerchantUserRepository;
import com.zaphira.user.repository.RegularUserRepository;
//import com.zaphira.user.repository.UserRepository;
import jakarta.servlet.http.HttpServletRequest;
import com.zaphira.user.event.EmailVerificationSuccessEvent;
import com.zaphira.user.event.UserRegistrationEvent;
