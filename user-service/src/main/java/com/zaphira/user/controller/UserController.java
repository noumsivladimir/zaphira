...
import com.zaphira.user.dto.request.ChangePinRequest;
import com.zaphira.user.dto.request.UpdateProfileRequest;
import com.zaphira.user.dto.request.VerifyEmailRequest;
import com.zaphira.user.dto.request.VerifyOtpRequest;
import com.zaphira.user.dto.response.UserNotificationInfoResponse;
import com.zaphira.user.dto.response.ApiResponse;
...
import com.zaphira.user.dto.response.UserVerificationStatusResponse;
...
import com.zaphira.user.service.UserRegistrationServiceImpl;
import com.zaphira.user.service.UserService;
import com.zaphira.user.service.SessionService;
import com.zaphira.user.service.TwoFactorService;
...
//        List<UserSecurityAnswer> findSecurityQuestionByUserId(Long userId)
    ...
    public ResponseEntity<ApiResponse<List<SessionResponse>>> getActiveSessions(
        ...
        List<SessionResponse> sessions = sessionService.getActiveSessions(userId, jwtToken);
    ...
    public ResponseEntity<ApiResponse<TwoFactorSetupResponse>> enableTwoFactor(
            @RequestAttribute("userId") Long userId) {
        TwoFactorSetupResponse response = twoFactorService.enableTwoFactorAuth(userId);
    ...
    public ResponseEntity<ApiResponse<Void>> disableTwoFactor(
        ...
        twoFactorService.disableTwoFactorAuth(userId, password);
    ...
    public ResponseEntity<ApiResponse<Boolean>> verifyTwoFactorCode(
            @RequestAttribute("userId") Long userId,
            @RequestParam String code) {
        boolean isValid = twoFactorService.verifyTwoFactorCode(userId, code);
        if (isValid) {
